...
> **Archived snapshot: 2026-03-26.** Lab footprint notebook — not current install advice.  
> **Current narrative:** [`../README.md`](../README.md) · **Recipes:** [`../../recipes/`](../../recipes/).  
> **June 2026 note:** stock vLLM ≥ v0.19 / official cu130; CUTLASS #40082; backends per-model via CLI flags.
